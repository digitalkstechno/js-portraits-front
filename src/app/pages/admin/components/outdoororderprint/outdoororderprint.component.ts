...
@Component({
  selector: 'app-outdoororderprint',
  imports: [SHARED_MODULES],
  templateUrl: './outdoororderprint.component.html',
  styleUrl: './outdoororderprint.component.css'
})
export class OutdoororderprintComponent {
  @Input() data: any; 
